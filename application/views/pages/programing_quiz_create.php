            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-text card-header-info">
                        <div class="card-text">
                            <h4 class="card-title">Programing Quiz Create</h4>
                        </div>
                    </div> 
                        ...
                        <form method="post">
                            ...
                            <div class="col">
                                    <div class="form-group">
                                        <label>Select A Programing Quiz Type</label>
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="card-body">
                        <form action="Programing_module/create" method="post">
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input type="hidden" name="type" value="<?= $_POST['type'] ?>">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label>Programing Quiz Name</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="pq_name" class="form-control"
                                            placeholder="Programing Quiz Name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer ">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <select name="batch" class="form-control">
                                            ...
                                            <option value="<?= $b_d['batch_id'] ?>,<?= $b_d['course_id'] ?>"><?= $b_d['batch_name']; echo " (".$b_d['course_name'].")"; ?></option>
                                            <?php } ?>
                                    </select>
                                    </div>
                                </div>
                        ...
                        <form action="Programing_module/create" method="post">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select name="group_batch" class="form-control">
                                            ...
                                            <option value="<?= $g_d['group_id'] ?>, <?= $g_d['batch_id'] ?>,<?= $g_d['course_id'] ?>"><?= $g_d['group_name']." ( ".$g_d['course_name']." )" ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="pq_name" class="form-control"
                                            placeholder="Programming Quiz Name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer ">
