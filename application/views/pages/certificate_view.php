...
<body style="background:#000">
    ...
    const img = new Image()
    img.src = "<?= base_url("assets/images/certificate/".$certificate_data['certificate_image']) ?>";
    img.onload = () => {
        ...
        // Name 
        context.font = "45px bold Libre Baskerville";
        ...
        context.fillText("<?php echo "";?>", 960, 870);
        context.font = "45px bold Libre Baskerville";
        context.fillStyle = "#FFCC2E";
        context.fillText("<?php echo "HAS COMPLETED THE ONLINE COURSE";?>", 960,950);
        context.textAlign = "center";
        context.font = "bold italic 45px Libre Baskerville";
        context.fillStyle = "#000000";
        context.fillText("<?php echo $certificate_data['line1'];?>", 960,1040);
        context.textAlign = "center";
        context.font = "bold italic 45px Libre Baskerville";
        context.fillStyle = "#000000";
        context.fillText("<?php echo $certificate_data['line2'];?>", 960,1100);
        context.textAlign = "center";
        context.font = "bold italic 45px Libre Baskerville";
        context.fillStyle = "#000000";
        context.fillText("<?php echo $certificate_data['line3'];?>", 960,1160);
        context.textAlign = "center";
        context.font = "bold 45px Libre Baskerville";
        context.fillStyle = "#000000";
        context.fillText("", 560,1260);
    }
